...
Dicom.el is available from [[https://elpa.gnu.org/packages/dicom.html][ELPA]] or [[https://melpa.org/#/dicom][MELPA]] and can be installed via ~M-x package-install RET dicom RET~.
